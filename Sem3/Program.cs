...
// 1. Универсальная функция поиска элемента в рандомном массиве.
...
// System.Console.WriteLine("Input min value of array: ");
// int minValue = Convert.ToInt32(Console.ReadLine());
// System.Console.WriteLine("Input max value of array: ");
...
// 3. Задайте массив из 10 элементов, заполненный числами из
...
// 4. Найдите произведения пар чисел в одномерном массиве. Парой
